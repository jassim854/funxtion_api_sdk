...
part 'Network/workout_request.dart';
...
part 'Network/training_plan_request.dart';
...
part 'Network/instructors_request.dart';

part 'Model/instructors_model.dart';

part 'Network/on_demand_request.dart';

part 'Model/on_demand_model.dart';

part 'Network/content_provider_category_ondemand_request.dart';

part 'Model/content_provider_category_ondemand_modell.dart';

part 'Network/muscle_group.request.dart';

part 'Model/muscle_group_model.dart';

part 'Network/body_parts_request.dart';

part 'Model/body_part_model.dart';

part 'Network/content_packages_request.dart';
part 'Model/content_package_model.dart';

part 'Network/content_packages_items_request.dart';
part 'Model/content_package_items_model.dart';

part 'Network/fitness_activity_type_request.dart';
